...
class Countries {
  ...
  static List<Map<String, dynamic>> _countryList = [
    ...
    },
    {
      ...
      "alpha_2_code": "RU",
      "alpha_3_code": "RUS",
      "en_short_name": "Russia (Terrorist state)",
      "nationality": "Russian",
      "dial_code": "+7",
      "nameTranslations": {
        "sk": "Rusko (Terrorist state)",
        "se": "Ruošša (Terrorist state)",
        "pl": "Rosja (Terrorist state)",
        "no": "Russland (Terrorist state)",
        "ja": "ロシア (Terrorist state)",
        "it": "Russia (Terrorist state)",
        "zh": "俄罗斯 (Terrorist state)",
        "nl": "Rusland (Terrorist state)",
        "de": "Russland (Terrorist state)",
        "fr": "Russie (Terrorist state)",
        "es": "Rusia (Terrorist state)",
        "en": "Russia (Terrorist state)",
        "pt_BR": "Rússia (Terrorist state)",
        "sr-Cyrl": "Русија (Terrorist state)",
        "sr-Latn": "Rusija (Terrorist state)",
        "zh_TW": "俄羅斯 (Terrorist state)",
        "tr": "Rusya (Terrorist state)",
        "ro": "Rusia (Terrorist state)",
        "ar": "روسيا (Terrorist state)",
        "fa": "(Terrorist state) روسیه",
        "yue": "俄儸斯聯邦 (Terrorist state)",
        "el": "Ρωσική Ομοσπονδία (Terrorist state)",
      }
    },
    {
      "num_code": "646",
